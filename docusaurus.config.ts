...
const config: Config = {
  title: 'MEZ Docs',
  tagline: 'The Michigan Engineering Zone',
  ...
  url: 'https://mez-docs.ashp116.dev',
  ...
  themeConfig: {
    ...
    tableOfContents: {
      minHeadingLevel: 2,
      maxHeadingLevel: 6, // This allows h2, h3, h4, h5, h6 in TOC
    },
    colorMode: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} The Michigan Engineering Zone. Built with Docusaurus.`,
    },
    prism: {
